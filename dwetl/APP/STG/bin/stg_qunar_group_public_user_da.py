...
def main(date):
	mysql_sql="python /home/q/dwetl/lib/py/db/DBLoader/loader.py --from tuandb3:qunar_group:public.user  --to hive:stg:stg_qunar_group_public_user_da  --split '\\001' --partition dt="+date+" --map profile";
	print mysql_sql;
...
if __name__=='__main__':
	...
	try:
		...
		send_email("stg_qunar_group_public_user_da",str(e),date_dt);
		os._exit(1);
