...
def main(date):
	mysql_sql="python /home/q/dwetl/lib/py/db/DBLoader/loader.py --from tuandb3:qunar_group:public.voucher_list --to hive:stg:stg_qunar_group_voucher_list_da --overwrite overwrite --split '\\001' --partition dt="+date;
	print mysql_sql;
...
if __name__=='__main__':
	...
	try:
		...
		send_email("stg_qunar_group_voucher_list_da failt",str(e),date_dt);
		os._exit(1);
