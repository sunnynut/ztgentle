// ORM class for table 'team_tags'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Jan 08 16:07:35 CST 2015
...
public class team_tags extends SqoopRecord  implements DBWritable, Writable {
  ...
  public team_tags with_team_id(Long team_id) {
    this.team_id = team_id;
    return this;
  }
  private String tag;
  ...
  public team_tags with_tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public team_tags with_district(String district) {
    this.district = district;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof team_tags)) {
      return false;
    }
    team_tags that = (team_tags) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.team_id = JdbcWritableBridge.readLong(1, __dbResults);
    this.tag = JdbcWritableBridge.readString(2, __dbResults);
    this.district = JdbcWritableBridge.readString(3, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeLong(team_id, 1 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeString(tag, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(district, 3 + __off, 12, __dbStmt);
    return 3;
  }
...
this.readFields0(__dataIn);  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.hiveStringReplaceDelims(tag==null?"null":tag, "\005", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with '\005' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(district==null?"null":district, "\005", delimiters));
    if (useRecordDelim) {
  ...
  public Object clone() throws CloneNotSupportedException {
    team_tags o = (team_tags) super.clone();
    return o;
  }

  public void clone0(team_tags o) throws CloneNotSupportedException {
  }
