...
t2.price_strategy,
t2.fast_payback, 
t2.camel_coin_strategy, 
t2.room_status) then 'R'
when t1.id is not null and t2.id is not null and md5(
t1.id,
t1.team_id, 
t1.ctserial, 
...
def load_data_to_mysql():
    ...
    SH_CMD1 = """python /home/q/desdev/sh_script/daily_report/delete_dwd_com_team_ext_his.py"""
    os.system(SH_CMD1)

    SH_CMD2 = """python /home/q/dwetl/lib/py/db/DBLoader/loader.py --to dw03Mysql:dwd:dwd_com_team_ext_his --from hive:dwd:dwd_com_team_ext_his_da  --split '\\001'  --choose choose --cond "select ext_info_seq,team_id, ctserial, create_time, update_time, redenvelope_enable_flag, promotion_type, meituan_ps_ext, partner_id, stock_status, price_strategy_id, price_strategy, fast_payback, camel_coin_strategy, room_status, effective_start_date, effective_end_date from dwd.dwd_com_team_ext_his_da where dt = '""" + data_dt + """'\""""
    print(SH_CMD2)
    os.system(SH_CMD2)
