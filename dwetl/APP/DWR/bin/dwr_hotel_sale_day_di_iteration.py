...
inner join(select * from dim.dim_team_his_da where dt='2015-04-07' and effective_end_date='4712-12-31' and group_id=4)t2
on t1.team_id=t2.team_id
inner join(select * from stg.stg_qunar_group_order_da where dt='2015-04-07')t3
