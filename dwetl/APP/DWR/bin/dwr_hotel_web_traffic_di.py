...
left outer join
  (select * from default.dim_hotel_agents where dt='""" + data_dt_int + """' and (business_type in ('QTA' ,'直销系') or (wrapper_id in ('waptuan0000','wituanhotel')))) b
on
